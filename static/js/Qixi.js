...
function init() {
	...
	var audioConfig = {
		enable: true, // 是否开启音乐
		playURL: 'http://pramy.oss-cn-shenzhen.aliyuncs.com/static/music/happy.mp3', // 正常播放地址
		cycleURL: 'http://pramy.oss-cn-shenzhen.aliyuncs.com/static/music/circulation.mp3' // 正常循环播放地址
	};
